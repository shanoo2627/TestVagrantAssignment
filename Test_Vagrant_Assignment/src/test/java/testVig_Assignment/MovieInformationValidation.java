...
public class MovieInformationValidation extends BaseClass {
	...
	public void imdbTest() {
		...
		//IMDBDetails_InformationPage imdb = new IMDBDetails_InformationPage(driver);
		imdb.getActualReleaseDate();
		imdb.getActualCountryName();
		...
		//WikiMovie_InformationPage wiki = new WikiMovie_InformationPage(driver);
